...
from build import get_buymeacoffee_stats, render_index, get_editions_config, get_latest_edition_info, get_edition_manifest
...
def test_get_editions_config(monkeypatch):
    ...
    monkeypatch.setattr('yaml.safe_load', lambda *args: mock_yaml_content)
